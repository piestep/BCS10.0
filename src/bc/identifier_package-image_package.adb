...
package body Identifier_Package.Image_Package is

   -- Return string representation of the identifier.

   function Image_Of (The_Identifier : Identifier_Pointer) return String is
   begin
...
end Identifier_Package.Image_Package;
